# M6 coding-agent evaluation — m2f1_w8a8

- Model: `/models/Qwen3.5-9B-w8a8`
- Prompts: tests/eval/coding_prompts.json
- Pass (compiles AND runs AND correct): **9/10**
- Gate ≥ 9/10: **PASS**
...
| `anagram` | python | ✅ | ✅ | ✅ |  |
| `max_subarray` | python | ❌ | ❌ | ❌ | py_compile: Sorry: IndentationError: unexpected indent (snippet.py, line 2) |
