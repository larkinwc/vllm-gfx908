...
#
# Per-cell launch script — w4a16_tp1_c1
#
# VAL-FINAL-005: pinned env, vLLM commit, ROCm version, tuning-JSON
# provenance for w4a16 TP=1 concurrency=1.
#
# Reproduces the cell's recorded output throughput within ±2 %.
#
# Usage:
#   launch_w4a16_tp1_c1.sh [--check]   # run the cell, compare to recorded ref
#   launch_w4a16_tp1_c1.sh --serve-only # just start the server, no bench
#
