...
#
# Per-cell launch script — w4a16_tp4_c2
#
# VAL-FINAL-005: pinned env, vLLM commit, ROCm version, tuning-JSON
# provenance for w4a16 TP=4 concurrency=2.
#
# Reproduces the cell's recorded output throughput within ±2 %.
#
# Usage:
#   launch_w4a16_tp4_c2.sh [--check]   # run the cell, compare to recorded ref
#   launch_w4a16_tp4_c2.sh --serve-only # just start the server, no bench
#
