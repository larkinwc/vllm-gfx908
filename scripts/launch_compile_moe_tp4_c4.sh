...
#
# torch.compile launch — FP16 Qwen3.5-35B-A3B MoE (256e/8a), TP=4 c=4.
...
#   compile (mode3+FULL_AND_PIECEWISE) tp4_c4 = 204.96 tok/s (+8.82% vs baseline).
set -euo pipefail
cell_id=compile_moe_tp4_c4
