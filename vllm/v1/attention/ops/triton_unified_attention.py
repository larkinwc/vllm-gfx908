...
def unified_attention(
    ...
    # Flash-Decoding: adaptive KV split count for the 3D path. For long
    # sequences with small batch sizes, increase the split count to fill
    # the GPU's CUs (MI100 has 120). Cap at the pre-allocated buffer.
    if use_3d and max_flash_decoding_splits is not None and max_seqlen_k > 0:
        ...
        num_segments = min(num_segments, softmax_segm_output.shape[2])
    elif use_3d:
