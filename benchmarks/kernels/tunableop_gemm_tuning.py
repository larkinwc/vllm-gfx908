...
Usage:
    ...
    python tunableop_gemm_tuning.py --mode tune \
        --input-file /root/tunableop-results/untuned_gemms.csv
...
if num_gpus > 1:
    ...
    if gpu_files:
        ...
        tunable.mgpu_tune_gemm_in_file(
            input_file.replace('.csv', '_gpu*.csv'), num_gpus
        )
    else:
...
#
# Generated by tunableop_gemm_tuning.py on {ts}
#
